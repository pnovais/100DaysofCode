'''
Program made with inspiration in the code
https://github.com/pnovais/BreakTime, from dsrelite

Given a list of youtube musics, this program open n times a random music
in a step of 1hour.
'''
